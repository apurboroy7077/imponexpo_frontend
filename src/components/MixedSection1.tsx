  ...
  return (
    <section>
      <div className=" px-2 py-7 lg:py-16   flex items-center justify-center">
        <div className="w-full max-w-[100rem] bg-[#f3f3f3] ">
                      ...
                      <div className=" px-2 py-1 flex items-center justify-between">
                        ...
                        <div>
                          <div className="text-[0.5rem]">
                            <button className="bg-[#f3f3f3] rounded px-4 py-[0.15rem] hover:bg-[black] hover:text-[white] font-medium active:scale-[0.99]">
                              Follow
                            </button>
                          </div>
                          <div>
