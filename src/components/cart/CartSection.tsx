  ...
  return (
    <TheSection2>
      ...
      <div className="hidden lg:block">
        <div>
          {/* THIS IS THE PRODUCTS CARD CONTAINER  */}
                  ...
                  <div className="w-[60%]">
                    <div>
                      <div className="mt-5 text-[#1c1c1c] text-base lg:text-2xl font-bold">
                        Men&apos;s Half Sleeve T-shirt Cotton Base Layer Slim
                        Muscle
                      </div>
                    </div>
                    <div>
        ...
        <div>
          <div className="py-5 text-center text-lg font-medium text-[#696969] border-t-[2px]">
