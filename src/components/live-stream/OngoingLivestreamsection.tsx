...
const OngoingLivestreamsection = () => {
  return (
    <TheSection>
      <div>
      ...
      <div>
        <div className=" mt-5 flex items-center justify-around flex-wrap gap-5 bg-[#fff7f5] rounded px-2 py-2 md:py-7">
          {[
            "All",
            "By Trending",
            "By Country",
            ...
            return (
              <div key={Math.random().toString()}>
                <button className="text-sm md:text-base text-[#0e1514] font-medium">
                  {data}
                </button>
              </div>
            );
          ...
          <div>
            <button>
              <img
                className="w-[1.5rem]"
                src="/icons/list-solid-orange.svg"
                alt=""
              />
            </button>
          </div>
...
export default OngoingLivestreamsection;
